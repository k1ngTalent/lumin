    ...
    return (
        <div className="cart-item">
            <div className="d-flex justify-content-between py-2">
                ...
                <span  className="pointer" onClick={() => { removeItem(item.id) }}>&#10006;</span>
            </div>
            ...
            <div className="row py-2">
                <div className="col-lg-6 col-sm-12  d-flex justify-content-between align-items-center">
                    <div className="quantity-selector d-flex justify-content-between align-items-center">
                        <span className="pointer" onClick={() => { decrement(item.id) }}>-</span>
                        <span className="px-1"> {item.quantity} </span>
                        <span className="pointer" onClick={() => { increment(item.id) }}>+</span>
                    </div>
                    <div>
