            ...
            <div className="product-grid-container">
                <div className="products row py-5">
                    {loading && [1,2,3,].map((item)=>(
                        <div className="product-container col-lg-4 col-sm-6 shimmer-div ">
                        <div className="lines shine  pl-0" style={{ width: "auto", height: "150px" }} ></div>
                        <div className="lines shine  pl-0 mt-2 mb-3" style={{ width: "auto", height: "15px" }} ></div>
                    ...
                    {productList?.map((product: any, index: number) => (
                        <div className="product-container col-lg-4 col-sm-6" key={index}>
                            <Product product={product} currency={currency?.cart?.cartCurrency} key={index} addToCart={addToCart}></Product>
                        </div>
