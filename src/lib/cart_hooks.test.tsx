...
const { toggleCartVisibilityState, updateCartItems, updateCartItemsProductInfo, updateCartCurrency, decrementQuantityOfCartItem, incrementQuantityOfCartItem, deleteCartItem } = useCart();
